...
TEST_CASE("either construction") {
  SECTION("primtive literals") {
    ...
    REQUIRE(e.lx == 1);
    REQUIRE(e.left);
    REQUIRE(alg_util::get_either<int>(e) == 1);
    e = Right<int,int>(2);
    REQUIRE(e.rx == 2);
    REQUIRE_FALSE(e.left);
    REQUIRE(alg_util::get_either<int>(e) == 2);
  }
  SECTION("struct literals") {
    ...
    REQUIRE(e.lx.x == 1);
    REQUIRE(e.left);
    REQUIRE(alg_util::get_either<ent>(e).x == 1);
    e = Right<ent,ent>(x);
    REQUIRE(e.rx.x == 1);
    REQUIRE_FALSE(e.left);
    REQUIRE(alg_util::get_either<ent>(e).x == 1);
  ...
  SECTION("class literals") {
    ...
    REQUIRE(e.lx.x == 1);
    REQUIRE(e.left);
    REQUIRE(alg_util::get_either<cls>(e).x == 1);
    e = Right<cls,cls>(x);
    REQUIRE(e.rx.x == 1);
    REQUIRE_FALSE(e.left);
    REQUIRE(alg_util::get_either<cls>(e).x == 1);
  ...
  SECTION("primitive pointer") {
    ...
    REQUIRE(*e.lx == 1);
    REQUIRE(e.left);
    REQUIRE(alg_util::get_either<int*>(e) == xp);
    REQUIRE(*alg_util::get_either<int*>(e) == 1);
    e = Right<int*,int*>(xp);
    REQUIRE(e.rx == xp);
    REQUIRE(*e.rx == 1);
  ...
  SECTION("struct pointer") {
    ...
    REQUIRE(e.lx == xp);
    REQUIRE(e.left);
    REQUIRE(alg_util::get_either<ent*>(e) == xp);
    REQUIRE(alg_util::get_either<ent*>(e)->x == 1);
    e = Right<ent*,ent*>(xp);
    REQUIRE(e.rx->x == 1);
    REQUIRE(e.rx == xp);
  ...
  SECTION("class pointer") {
    ...
    REQUIRE(e.lx == xp);
    REQUIRE(e.left);
    REQUIRE(alg_util::get_either<cls*>(e) == xp);
    REQUIRE(alg_util::get_either<cls*>(e)->x == 1);
    e = Right<cls*,cls*>(xp);
    REQUIRE(e.rx->x == 1);
    REQUIRE(e.rx == xp);
